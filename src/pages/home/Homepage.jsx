    ...
    <>
      ...
      <div className="relative h-full w-full flex items-center justify-center">
        <div className="profileCard_container relative p-10 border-2 border-dashed rounded-full border-spacing-4 border-gray-400/50">
          <button className="profile_item left-[45px] -top-[4px] absolute rounded-full bg-cover cursor-pointer border border-skyBlue p-[2px] active:scale-95 hover:scale-95 transition-all duration-500">
          ...
          <button className="profile_item right-[40%] -bottom-4 absolute rounded-full bg-cover cursor-pointer border border-gray-400/50 p-[2px] active:scale-95 hover:scale-95 transition-all duration-500">
            <span className="block w-[40px] h-[40px] transition-all duration-500 rounded-full z-[2] bg-certainWhite p-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <button className="profile w-[200px] h-[200px] p-1 border-2 border-e-8 rounded-full border-skyBlue cursor-pointer transition-all duration-500 z-0">
            <div className="profile w-full bg-certainWhite h-full flex items-center justify-center p-2 rounded-full active:scale-95 hover:scale-95 object-cover transition-all duration-500">
